...
{
    floatS = (floatTriSide2_par + floatTriSide2_par + floatTriSide3_par)/2;
    floatTriangleArea = Math.sqrt((floatS*(floatS-floatTriSide1_par)*(floatS-floatTriSide2_par)*(floatS-floatTriSide3_par)));
